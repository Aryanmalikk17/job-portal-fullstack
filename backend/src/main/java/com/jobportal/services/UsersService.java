...
public class UsersService {
    ...
    // REST API compatible method - returns null instead of throwing exception
    public Users findByEmail(String email) {
        return usersRepository.findByEmail(email).orElse(null);
    }

    // Original method for existing Thymeleaf controllers
    public Users findByEmailRequired(String email) {
    ...
    // New method for finding user by ID - Frontend compatibility
