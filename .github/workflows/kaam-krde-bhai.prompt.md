...
- **Authentication:** You will load the `FIREBASE_ADMIN_TOKEN` securely from the `.env` file.
...
# EXECUTION CONTRACT
When invoked, you will bridge to the physical terminal to run the optimized ingestion engine:
```bash
node /Users/apple/Documents/github-agents/scripts/ingestion-agent.js "<file_path>" "<category>"
```
